...
class LayercapturedatacollectPlugin(octoprint.plugin.SettingsPlugin,
    ...
    def get_update_information(self):
        ...
        return {
            "LayerCaptureDatacollect": {
                "displayName": "Layercapturedatacollect Plugin",
...
__plugin_name__ = "Layercapturedatacollect Plugin"
